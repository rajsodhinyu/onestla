    ...
    <div className="">
      <div className="relative w-screen h-dvh *:m-15 *:">
        ...
        <div className="bg-[#f5f5dc] absolute z-10 top-0 left-0 right-0 h-[15%] border-blue-600 border-0 rounded-t-lg justify-between flex flex-wrap lg:flex-nowrap items-center text-[#671E1E]">
          <div className="text-[12vw] mt-[10%] sm:mt-[5%] md:mt-[1%] sm:text-[10vh] font-[800] italic self-center font-[Switzer] tracking-wide ml-8 ">
            on est là
          </div>
        ...
        <div className="absolute z-0 top-[14%] bg-[#f5f5dc] bottom-[0%] right-0 w-[30%]  border-yellow-600 rounded-r-lg border-0 md:inline hidden font-[Caveat] shadow-2xl ">
